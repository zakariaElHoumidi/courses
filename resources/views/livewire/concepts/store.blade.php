<div class="modal fade show" style="display: block" id="storeConcept" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="storeConcept">Store Concept</h1>
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <input id="description" type="text" class="form-control shadow-sm @error('label') is-invalid @enderror"
                ...
                <div class="mb-3">
                    ...
                    <select id="category_id" type="text" class="form-select shadow-sm @error('label') is-invalid @enderror"
                ...
                <div class="mb-3">
                    ...
                    <select id="language_id" type="text" class="form-select shadow-sm @error('label') is-invalid @enderror"
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" wire:click="storeConcept">Store</button>
            </div>
        </div>
    </div>
</div>
