<div class="modal fade show" style="display: block" id="storeLanguage" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="storeLanguage">Store Language</h1>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" wire:click="storeLanguage">Store</button>
            </div>
        </div>
    </div>
</div>
